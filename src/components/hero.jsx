    ...
    <section className="hero">
      <div className="container">
        ...
        <div className="hero-right">
          <h1>{showInbox ? 'Inbox' : showCalendar ? 'Upcoming Calendar' : showToday ? 'Today' : showCompleted ? 'Completed Tasks' : showTeams ? 'Your Teams' : 'Welcome to our Schedule Manager'}</h1>
          {
            showInbox ? (
